...
namespace TranslatingGrammar
{
    public class TransGrammar : Grammar
    {
        public List<OPSymbol> SigmaA { set; get;} = null;
        ...
        public TransGrammar(List<Symbol> V, List<Symbol> SigmaI, List<OPSymbol> SigmaA, string S)
        {
            this.V = V;
            this.T = SigmaI;
            this.SigmaA = SigmaA;
        ...
        public TransGrammar(List<Symbol> V, List<Symbol> SigmaI, List<OPSymbol> SigmaA, List<Production> P, string S)
        {
            this.V = V;
            this.T = SigmaI;
            this.SigmaA = SigmaA;
    ...
    public void AddRule(Symbol lhs, List<Symbol> rhs)
        ...
        public List<Symbol> transformInSymbols(string inputChain)
        {
            ...
            foreach (char c in inputChain)
            {
                ...
                } else
                {
                    if (isOPSymbol)
                    {
                        result.Add(new OPSymbol(c.ToString()));
                    } else
                    {
        ...
        class ConverterInTransGrammar : SLRGrammar
        {
        ...
        public TransGrammar ConvertInTransGrammar(Grammar CFGrammar, string input, string transChain)
        {
            ...
            TransGrammar result = new TransGrammar(CFGrammar.V, CFGrammar.T, new List<OPSymbol>(), CFGrammar.P, CFGrammar.S0.symbol);
                ...
                switch (tableCondition.First.symbol)
                {
                    ...
                    case "R":
                        ...
                        if (P[rulePos].RHS.Count == 1 && isNoTerm(P[rulePos].RHS[0].symbol))
                        {
                            ...
                            Console.WriteLine(P[rulePos].LHS.symbol + " -> ");
                        ...
                        {
                            result.P[rulePos - shift].RHS.Add(new OPSymbol(transChain[0].ToString()));
